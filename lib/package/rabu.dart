...
class RabuPage extends StatefulWidget {
  const RabuPage({Key? key}) : super(key: key);

  @override
  State<RabuPage> createState() => _JadwalShalatState();
}

class _JadwalShalatState extends State<RabuPage> {
  String subuh = '';
  String zuhur = '';
  String ashar = '';
  String magrib = '';
  ...
  void initState() {
    ...
    // Set the selected date to the nearest Wednesday
    selectedDate = _getNearestWednesday(selectedDate);
    getPrayerTimes(selectedDate);
  }

  // Function to get the nearest Wednesday
  DateTime _getNearestWednesday(DateTime date) {
