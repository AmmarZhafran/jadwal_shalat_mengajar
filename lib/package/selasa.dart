...
class SelasaPage extends StatefulWidget {
  const SelasaPage({Key? key}) : super(key: key);

  @override
  State<SelasaPage> createState() => _JadwalShalatState();
}

class _JadwalShalatState extends State<SelasaPage> {
  String subuh = '';
  String zuhur = '';
  String ashar = '';
  String magrib = '';
  ...
  void initState() {
    ...
    // Set the selected date to the nearest Tuesday
    selectedDate = _getNearestTuesday(selectedDate);
    getPrayerTimes(selectedDate);
  }

  // Function to get the nearest Tuesday
  DateTime _getNearestTuesday(DateTime date) {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (picked != null && picked != selectedDate) {
      setState(() {
        selectedDate = picked;
        // Ensure selected date is a Tuesday
        selectedDate = _getNearestTuesday(selectedDate);
      });
      getPrayerTimes(selectedDate);
    }
